...
// By setting the CSGTM_CONTAINERS_VALIDATION_FAILEdLOG and
// CSGTM_CONTAINERS_VALIDATION_FAILEdASSERT macros you can control what happens
// when a validation fails. If you implement your own validators, you may want
// to control their internals using the same macros for consistency.
#ifndef CSGTM_CONTAINERS_VALIDATION_FAILEdASSERT
#define CSGTM_CONTAINERS_VALIDATION_FAILEdASSERT 0
#endif
...
#if __LP64__ || NS_BUILd32_LIKE_64
